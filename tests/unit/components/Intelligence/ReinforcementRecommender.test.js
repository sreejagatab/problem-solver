// Intelligence/ReinforcementRecommender.test.js
import React from 'react';
import { render, screen, fireEvent } from '@testing-library/react';
import ReinforcementRecommender from '../../../src/components/Intelligence/ReinforcementRecommender';
...
test('renders personalized recommendations', () => {
  render(<ReinforcementRecommender />);
...
test('calls viewRecommendation function on button click', () => {
  ...
  render(<ReinforcementRecommender onViewRecommendation={handleViewRecommendation} />);
